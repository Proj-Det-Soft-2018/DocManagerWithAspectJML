			...
			<fo:page-sequence master-reference="all-pages">
								...
								<fo:table-row>
									...
									<fo:table-cell text-align="center" width="35em">
										<fo:block>
											...
											Sistema de controle de processos para compra de materiais -
											DocManager Purchase&#8232;
											&#8232;
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-size="1.5em" font-weight="bold"
						...
						DECLARAÇÃO DE STATUS DO PROCESSO DE COMPRA
					</fo:block>
						...
						<fo:table-body>
							...
							<fo:table-row role="tr">
								<fo:table-cell number-columns-spanned="2">
									<fo:block>
										<fo:inline font-weight="bold" role="strong">FORNECEDOR
										</fo:inline>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell>
									<fo:block>
										<fo:inline font-weight="bold">Razão Social:</fo:inline>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block><xsl:value-of select="interested/business-name"/></fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell>
									<fo:block>
										<fo:inline font-weight="bold">CNPJ:</fo:inline>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block><xsl:value-of select="interested/cnpj"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell>
									<fo:block>
										<fo:inline font-weight="bold">Responsável:</fo:inline>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block><xsl:value-of select="interested/liable-name"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								...
								<fo:table-cell>
									<fo:block><xsl:value-of select="interested/liable-cpf"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
			        ...
			        <fo:table margin="0 0.2cm" table-layout="fixed" width="100%-0.4cm">
			          <fo:table-body>
			            ...
			            <fo:table-row>
			              <fo:table-cell>
			                <fo:block>
			                  <fo:inline font-weight="bold">Tipo de Material:</fo:inline>
			                </fo:block>
			              </fo:table-cell>
			              <fo:table-cell>
